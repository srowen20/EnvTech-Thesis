...
def extract_samples_ee(point: ee.Geometry, 
    ...
    def sample_img(img) -> dict:
        try:
            ...
            # Cloud probability center pixel
            ...
            # Cloud probability patch as array
...
def main():
    ...
    parser.add_argument("--df_path", type=str, default="data/modelling/baseline_datasets/processed/for_sentinel2_biggerwindow_leastcloudy_collection/20250802_leastcloudy_imagedateassurveydate.csv", help="Soil file path.")
    ...
    parser.add_argument("--start_date_offset", type=int, default=32, help="Number of days before survey date to include.")
    parser.add_argument("--end_date_offset", type=int, default=1, help="Number of days after survey date to include.")
    parser.add_argument("--save_path", type=str, default="./data/raw/20250802_sentinel_bands_and_cloud_0-32days_radius5.txt", help="Txt file to save the sample outputs to.")
    ...
    parser.add_argument("--radius", type=int, default=5, help="Pixel radius for averaging values over.")
